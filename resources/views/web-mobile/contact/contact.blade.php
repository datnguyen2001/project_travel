...
@section('plugins_css')
    ...
    <link rel="stylesheet" href="{{asset('dist/web-mobile/contact/contact.css')}}">
@stop
@section('style_page')
@stop
...
@section('content')
    ...
    @include('web-mobile.contact.content')
@stop
...
@section('script_page')
    ...
    <script src="{{asset('dist/web-mobile/contact/contact.js')}}"></script>
@stop
