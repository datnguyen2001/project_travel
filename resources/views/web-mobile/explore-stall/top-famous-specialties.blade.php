<section class="top-famous-specialties-section mobile" id="top-famous">
    <div class="container">
        <div class="menu-home-2">
            <h5 style="font-weight: 600">Top những đặc sản nổi tiếng tại Vĩnh Phúc</h5>
            <div class="tabs-content" id="tabs-content">
                <div id="tab1" class="tab-content-1">
                    <div class="slider-top-famous-block">
                        @foreach($booth_top as $value)
                            <div class="slider-top-famous">
                                <div class="img-wrap">
                                    ...
                                    <a href="{{route('web.explore-stall.detail', $value->slug)}}">
                                        <div class="desc">
                                            ...
                                            <div class="rating-block align-items-end">
                                                    <div class="name">
                                                    <p style="width: 133px;-webkit-box-orient: vertical;-webkit-line-clamp: 1!important;overflow: hidden;text-overflow: ellipsis;">{{number_format($value->price)}}đ-{{number_format($value->price_2)}}đ</p>
                                                </div>
                                                <div>
