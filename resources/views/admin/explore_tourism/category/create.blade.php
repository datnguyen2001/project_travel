...
@section('main')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 class="text-capitalize">Tạo Danh Mục</h1>
        </div><!-- End Page Title -->
        <section class="section dashboard">
            <div class="bg-white p-4">
                ...
                @endif
                <form action="{{route('admin.explore_tourism.category.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <select class="form-select" name="type">
                                <option value="1">Khám phá du lịch</option>
                                <option value="2">Khám phá Ẩm thực,Booking,Gian Hàng</option>
                                <option value="3">Tin tức mới nhất</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-3">
