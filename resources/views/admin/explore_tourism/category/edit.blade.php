    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                ...
                @endif
                <form action="{{url('admin/explore_tourism/category/update/'.$category->slug)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-3">
                        <div class="col-3">{{'Thuộc lĩnh vực :'}}</div>
                        <div class="col-8">
                            <select class="form-select" name="type">
                                <option value="1" @if($category->type == 1) selected @endif>Khám phá du lịch</option>
                                <option value="2" @if($category->type == 2) selected @endif>Khám phá Ẩm thực,Booking,Gian Hàng</option>
                                <option value="3" @if($category->type == 3) selected @endif>Tin tức mới nhất</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-8 d-flex justify-content-end">
                            <a href="{{route('admin.explore_tourism.category.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
