        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{route('admin.introduce.superApp.update',$superApp->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-3">{{'Tiêu đề bài viết :'}}</div>
                            <div class="col-8">
                                <input class="form-control" name="title" type="text" value="{{$superApp->title}}" required>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Mô tả ngắn :'}}</div>
                            <div class="col-8">
                                <textarea class="form-control" name="content" type="text" required rows="4" >{{$superApp->content}}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Our Explores :'}}</div>
                            <div class="col-8">
                                <input class="form-control" name="Explores" type="text" value="{{$superApp->Explores}}" required>
                            </div>
                        </div><div class="row mt-3">
                            <div class="col-3">{{'Destinations :'}}</div>
                            <div class="col-8">
                                <input class="form-control" name="Destinations" type="text" value="{{$superApp->Destinations}}" required>
                            </div>
                        </div><div class="row mt-3">
                            <div class="col-3">{{'Year Experience :'}}</div>
                            <div class="col-8">
                                <input class="form-control" name="Experience" type="text" value="{{$superApp->Experience}}" required>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Thứ tự :'}}</div>
                            <div class="col-8">
                                <input class="form-control" name="index" type="number" value="{{$superApp->index}}">
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <label class="switch">
                                    <input type="checkbox" @if($superApp->display == 1) checked @endif name="display">
                            ...
                            <div class="col-8">
                                <div class="form-control position-relative div-parent-1" style="padding-top: calc(50% + 46px);">
                                    <button type="button" class="position-absolute border-0 bg-transparent select-img-1" style="top: 50%;left: 50%;transform: translate(-50%,-50%)">
                                        <img src="{{$superApp->img_1}}" class="w-100 h-100" style="object-fit: cover">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <div class="form-control position-relative div-parent-2" style="padding-top: calc(50% + 46px);">
                                    <button type="button" class="position-absolute border-0 bg-transparent select-img-2" style="top: 50%;left: 50%;transform: translate(-50%,-50%)">
                                        <img src="{{$superApp->img_2}}" class="w-100 h-100" style="object-fit: cover">
{{--                                        <i style="font-size: 30px" class="bi bi-download"></i>--}}
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-3">{{'Hình ảnh 3 :'}}</div>
                            <div class="col-8">
                                <div class="form-control position-relative div-parent-3" style="padding-top: calc(50% + 46px);">
                                    <button type="button" class="position-absolute border-0 bg-transparent select-img-3" style="top: 50%;left: 50%;transform: translate(-50%,-50%)">
                                        <img src="{{$superApp->img_3}}" class="w-100 h-100" style="object-fit: cover">
{{--                                        <i style="font-size: 30px" class="bi bi-download"></i>--}}
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-8 d-flex justify-content-end">
                                <a href="{{route('admin.introduce.superApp.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
