        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{route('admin.introduce.superApp.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <input class="form-control" name="Explores" type="text" required>
                            </div>
                        </div><div class="row mt-3">
                            <div class="col-3">{{'Destinations :'}}</div>
                            <div class="col-8">
                                <input class="form-control" name="Destinations" type="text" required>
                            </div>
                        </div><div class="row mt-3">
