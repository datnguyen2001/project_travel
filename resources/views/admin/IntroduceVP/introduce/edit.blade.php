        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{route('admin.introduce_VP.introduce.update', $introduce->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea class="form-control" name="content" type="text" required rows="4">{{$introduce->content}}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-8">
                                <div class="form-control position-relative div-parent" style="padding-top: calc(50% + 46px);">
                                    <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                        ...
                                        @if($introduce->is_video == 2)
                                            <video class="w-100 h-100" style="object-fit: cover" controls>
                                                <source src="{{$introduce->src}}">
                                            </video>
                                        @else
                                            <img src="{{$introduce->src}}" class="w-100 h-100" style="object-fit: cover">
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-3">{{'Hình ảnh 1 (Trang Home) :'}}</div>
                            <div class="col-8">
                                <div class="form-control position-relative div-parent-1" style="padding-top: calc(50% + 46px);">
                                    <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                        ...
                                        <img src="{{$introduce->img_1}}" class="w-100 h-100" style="object-fit: cover">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Hình ảnh 2 (Trang Home) :'}}</div>
                            <div class="col-8">
                                <div class="form-control position-relative div-parent-2" style="padding-top: calc(50% + 46px);">
                                    <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                        ...
                                        <img src="{{$introduce->img_2}}" class="w-100 h-100" style="object-fit: cover">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Nội dung bài viết :'}}</div>
                            <div class="col-8">
                                <textarea class="tinymce-editor" name="posts" type="text" >{!! $introduce->posts !!}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Vị trí:'}}</div>
                            <div class="col-8">
                                <input name="index" class="form-control" value="{{$introduce->index}}" required type="text">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Tác giả:'}}</div>
                            <div class="col-8">
                                <input name="author" class="form-control" value="{{$introduce->author}}" required type="text">
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-8 d-flex justify-content-end">
                                <a href="{{route('admin.introduce_VP.introduce.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
