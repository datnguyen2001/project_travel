        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{route('admin.introduce_VP.tradition.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea class="form-control" name="content" type="text" required rows="4"></textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea class="tinymce-editor" name="posts" type="text" ></textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Vị trí:'}}</div>
                            <div class="col-8">
                                <input name="index" class="form-control" required type="text">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Tác giả:'}}</div>
                            <div class="col-8">
                                <input name="author" class="form-control" required type="text">
                            </div>
                        </div>
                        <div class="row mt-3">
