...
@section('main')
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex align-items-center justify-content-between">
            <h1>Danh sách</h1>
            <a href="{{route('admin.introduce_VP.tradition.create')}}" class="btn btn-info text-white">Thêm mới</a>
        </div><!-- End Page Title -->
                ...
                @if(count($listData))
                    @foreach($listData as $key => $value)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{route('admin.introduce_VP.tradition.edit',$value->id)}}" type="button" class="btn btn-success" style="border-radius: inherit">Sửa</a>
...
@section('script')
    <script>
        ...
        $(".btn-delete").click(function () {
            let value = $(this).val();
            let url = window.location.origin +'/admin/introduce_VP/tradition/delete/' + value;
            $.confirm({
                title: 'Xác nhận!',
