...
@section('main')
    <main id="main" class="main">
        ...
        <form class="d-flex align-items-center" method="get" action="{{route('admin.book_tour.contact')}}">
        ...
        <form class="d-flex align-items-center" method="get" action="{{route('admin.book_tour.contact')}}">
            ...
            <a href="{{route('admin.book_tour.contact')}}" class="btn btn-danger" style="margin-left: 15px">Hủy </a>
        </form>
