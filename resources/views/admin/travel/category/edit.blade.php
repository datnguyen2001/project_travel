    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                ...
                @endif
                <form action="{{route('admin.travel.category.update', $category->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-8 d-flex justify-content-end">
                            <a href="{{route('admin.travel.category.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
