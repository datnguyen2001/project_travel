...
@section('main')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 class="text-capitalize">Sửa danh mục</h1>
        </div><!-- End Page Title -->
        <section class="section dashboard">
            <div class="bg-white p-4">
                ...
                @endif
                <form action="{{route('admin.booking.convenient.update',$convenient->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-3">{{'Title :'}}</div>
                        <div class="col-8">
                            <input class="form-control" name="name" value="{{$convenient->name}}" type="text" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <div class="form-control position-relative div-parent" style="padding-top: 50%">
                                <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                    ...
                                    <img src="{{$convenient->icon}}" style="object-fit: cover;max-width: 100%;max-height: 100%">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5">
                        ...
                        <div class="col-8 d-flex justify-content-end">
                            <a href="{{route('admin.booking.convenient.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
