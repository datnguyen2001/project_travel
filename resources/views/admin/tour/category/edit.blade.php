    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                ...
                @endif
                <form action="{{route('admin.tourist.category.update', $category->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-3">{{'Title :'}}</div>
                        <div class="col-8">
                            <input class="form-control" name="title" value="{{$category->title}}" type="text" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-3">{{'Biểu tượng :'}}</div>
                        <div class="col-8">
                            <div class="form-control position-relative div-parent" style="padding-top: 50%">
                                <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                    ...
                                    <img src="{{$category->banner}}" class="w-100 h-100" style="object-fit: cover">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <div class="form-control position-relative video-review" style="padding-top: 50%">
                                <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-8 d-flex justify-content-end">
                            <a href="{{route('admin.tourist.category.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
