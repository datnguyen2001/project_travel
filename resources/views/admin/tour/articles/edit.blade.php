        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{route('admin.tourist.articles.update', $articles->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-8">
                                <select class="form-select" name="category" required>
                                    ...
                                    @foreach($category as $value)
                                        <option value="{{$value->id}}" @if($articles->category_id == $value->id) selected @endif>{{$value->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
