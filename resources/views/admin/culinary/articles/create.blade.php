        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{route('admin.culinary.articles.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea name="content_1" class="tinymce-editor"></textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea name="content_2" class="tinymce-editor"></textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <input name="rating" class="form-control format-currency" required type="text">
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-8 d-flex justify-content-end">
                                <a href="{{route('admin.culinary.articles.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
