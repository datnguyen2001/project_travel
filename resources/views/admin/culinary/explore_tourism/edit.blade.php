        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{route('admin.culinary.explore_tourism.update',$post->slug)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea class="form-control" name="content" type="text" required maxlength="255" rows="4">{{$post->content}}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <select class="form-select" name="category" required>
                                    ...
                                    @foreach($category as $value)
                                        <option value="{{$value->id}}" @if($post->category == $value->id) selected @endif>{{$value->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-8">
                                <div class="form-control position-relative div-parent-1" style="padding-top: calc(50% + 46px);">
                                    <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                        ...
                                        @else
                                            <img src="{{$post->src}}" class="w-100 h-100" style="object-fit: cover">
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-3">{{'Ảnh/Video bài viết :'}}</div>
                            <div class="col-8">
                                <div class="form-control position-relative div-parent" style="padding-top: calc(50% + 46px);">
                                    <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                        ...
                                        @if($post->is_video == 1)
                                            <video class="w-100 h-100" style="object-fit: cover" controls>
                                                <source src="{{$post->banner}}">
                                            </video>
                                        @else
                                            <img src="{{$post->banner}}" class="w-100 h-100" style="object-fit: cover">
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea name="content_img" class="tinymce-editor">{!! $post->content_img !!}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <textarea name="content_video" class="tinymce-editor">{!! $post->content_video !!}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Đánh giá bài viết:'}}</div>
                            <div class="col-8">
                                <input name="rating" value="{{$post->rating}}" class="form-control format-currency" type="text">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Thứ tự sắp xếp :'}}</div>
                            <div class="col-8">
                                <input name="index" value="{{$post->index}}" class="form-control format-currency" type="text">
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <label class="switch">
                                    <input type="checkbox" @if($post->display == 1) checked @endif name="display">
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Sử dụng layout :'}}</div>
                            <div class="col-8">
                                <select name="layout" class="form-select">
                                    <option value="1" @if($post->layout == 1) selected @endif>Layout 1</option>
                                    <option value="2" @if($post->layout == 2) selected @endif>Layout 2</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mt-5">
                            ...
                            <div class="col-8 d-flex justify-content-end">
                                <a href="{{route('admin.culinary.explore_tourism.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
