...
@section('main')
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1 class="text-capitalize">{{$hotel->name}}</h1>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <div class="bg-white p-4">
                    ...
                    @endif
                    <form action="{{url('admin/tour/tour_area/update',$hotel->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-3">{{'Tên tour  :'}}</div>
                            <div class="col-8">
                                <input class="form-control" name="name" value="{{$hotel->name}}" type="text" required>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'SĐT quản lý tour  :'}}</div>
                            <div class="col-8">
                                <input class="form-control" value="{{$hotel->phone}}" name="phone" type="tel" required>
                            </div>
                        </div>
{{--                        <div class="row mt-3">--}}
{{--                            <div class="col-3">{{'Mô tả ngắn :'}}</div>--}}
{{--                            <div class="col-8">--}}
{{--                                <textarea class="form-control" name="content" type="text" required maxlength="255" rows="4">{{$hotel->content}}</textarea>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        <div class="row mt-3">
                                    ...
                                    <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                        ...
                                        @if($hotel->is_video == 1)
                                            <video class="w-100 h-100" style="object-fit: cover" controls>
                                                <source src="{{$hotel->banner}}">
                                            </video>
                                            @else
                                            <img src="{{$hotel->banner}}" class="w-100 h-100" style="object-fit: cover">
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-8">
                                <div class="form-control position-relative div-parent-3" style="padding-top: calc(50% + 46px);">
                                    <div class="position-absolute w-100 h-100 div-file d-flex justify-content-center align-items-center" style="top: 0; left: 0;z-index: 10">
                                        ...
                                        <img src="{{$hotel->src}}" class="w-100 h-100" style="object-fit: cover">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <div class="d-flex align-items-center">
                                    <input name="price" type="text" value="{{number_format($hotel->price)}}" required class="form-control format-currency" placeholder="Từ">
                                    <input name="price_2" type="text" value="{{number_format($hotel->price_2)}}" required class="form-control format-currency" placeholder="Đến">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <div class="d-flex align-items-center">
                                    <input name="address" value="{{$hotel->address}}" type="text" required class="form-control">
                                </div>
                                <div class="mt-3">
                                    <p class="m-0">Tọa độ</p>
                                    <input name="map" type="text" value="{{$hotel->map}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                ...
                                <div class="d-flex align-items-center">
                                    <input name="rating_address" value="{{$hotel->rating_address}}" type="text" class="form-control" placeholder="Vị trí">
                                    <input name="rating_price" value="{{$hotel->rating_price}}" type="text" class="form-control" placeholder="Giá cả">
                                    <input name="rating_service" value="{{$hotel->rating_service}}" type="text" class="form-control" placeholder="Phục vụ">
                                    <input name="rating_toilet" value="{{$hotel->rating_toilet}}" type="text" class="form-control" placeholder="Vệ sinh">
                                    <input name="rating_convenient" value="{{$hotel->rating_convenient}}" type="text" class="form-control" placeholder="Tiện nghi">
                                </div>
                                <p class="m-0 mt-2">Lời bình</p>
                                <textarea class="form-control" name="rating_content" type="text" maxlength="255" rows="4">{{$hotel->rating_content}}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <select class="form-select" name="category">
                                    ...
                                    @foreach($category as $value)
                                        <option value="{{$value->id}}" @if($hotel->category == $value->id) selected @endif>{{$value->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-3">{{'Nội dung tour:'}}</div>
                            <div class="col-8">
                                <textarea name="content" class="tinymce-editor">{!! $hotel->content !!}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <label class="switch">
                                    <input type="checkbox" @if($hotel->active == 1) checked @endif name="active">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-8 d-flex justify-content-end">
                                <a href="{{route('admin.tour.tour_area.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
