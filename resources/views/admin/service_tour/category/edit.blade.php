...
@section('main')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 class="text-capitalize">Sửa danh mục Tour</h1>
        </div><!-- End Page Title -->
        <section class="section dashboard">
            <div class="bg-white p-4">
                ...
                @endif
                <form action="{{url('admin/tour/category/update/'.$category->slug)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-8 d-flex justify-content-end">
                            <a href="{{route('admin.tour.category.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
