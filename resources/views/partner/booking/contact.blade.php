...
@section('main')
    <main id="main" class="main">
        ...
        <form class="d-flex align-items-center" method="get" action="{{route('partner.book_room.contact')}}">
        ...
        <form class="d-flex align-items-center" method="get" action="{{route('partner.book_room.contact')}}">
            ...
            <a href="{{route('partner.book_room.contact')}}" class="btn btn-danger" style="margin-left: 15px">Hủy </a>
        </form>
