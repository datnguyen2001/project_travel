...
@section('main')
    <main id="main" class="main">
        ...
        <form class="d-flex align-items-center" method="get" action="{{route('partner.book_room.index')}}">
            ...
            <a href="{{route('partner.book_room.index')}}" class="btn btn-danger" style="margin-left: 15px">Hủy </a>
        </form>
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.ajax({
                                url: window.location.origin + '/partner/book_room/sale/'+ value,
                                data: data,
                                type: 'post',
                                dataType: 'json',
