<section class="row container-block-search">
    <form action="{{url($url)}}" method="get" class="col-lg-4 col-md-12 col-sm-12 block-filter mb-2">
        ...
        <div class="block-filter-detail">
            <div class="filter-header">
                ...
                <a href="{{url($url)}}"><h3 class="filter-reset">Xoá tất cả </h3></a>
            </div>
