...
@section('content')
    ...
    @include('web.travelling.category')
    @include('web.travelling.image-category')
    @include('web.travelling.video-category')
    @include('web.travelling.feedback-and-review-category')
