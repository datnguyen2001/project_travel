<section class="top-famous-specialties-section" id="top-famous">
    <div class="container">
        <div class="menu-home-2">
            <h3>Top những đặc sản nổi tiếng tại Vĩnh Phúc</h3>
            <div class="tabs-content" id="tabs-content">
                <div id="tab1" class="tab-content-1">
                    <div class="slider-top-famous__slick">
                        @foreach($booth_top as $value)
                            <div class="slider-top-famous__item">
                                <div class="img-wrap">
                                    ...
                                    <a href="{{route('web.explore-stall.detail', $value->slug)}}">
                                        <div class="desc">
                                            ...
                                            <div class="address d-flex">
                                                ...
                                                <span class="title content-drop-1-line" style="display: -webkit-box!important;margin-left: 5px">{{$value->address}}</span>
                                            </div>
                                            <div class="name">
                                                <p class="title content-drop-1-line">{{number_format($value->price)}}đ-{{number_format($value->price_2)}}đ</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
