<section class="what-do-eat-here-section" id="what-do-eat-here" style="background:linear-gradient(
    rgba(0, 0, 0, 0.6),
    rgba(0, 0, 0, 0.6)
    ), url('{{asset('images/banner/banner-product.png')}}')">
    <div class="container">
        <div class="menu-home-2">
            <h3 class="title-block-white">Ăn gì ở đây?</h3>
            <div class="tabs-content" id="tabs-content">
                <div id="tab1" class="tab-content-1">
                    <div class="slider-what-do-eat-here__slick">
                        @foreach($booth as $value)
                            <div class="slider-what-do-eat-here__item">
                                <div class="img-wrap">
